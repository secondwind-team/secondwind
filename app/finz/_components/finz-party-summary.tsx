...
export function FinzPartySummaryCard({ summary }: { summary: FinzPartySummary }) {
  return (
    <section className="fz-bubble fz-bubble--amber p-5">
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-[var(--fz-ink)]">{summary.summary}</p>
      <p className="mt-2 text-sm font-semibold leading-relaxed text-[var(--fz-amber-ink)]">{summary.nextNudge}</p>
