...
// 대화 탭 본문(클라이언트). 방 목록은 서버(SSR)에서 받아 prop 으로 시드 — 클라이언트 mount fetch 없음
// (us-east 함수 왕복 1회 절감). 목록은 페이지 재방문(서버 재렌더) 때 갱신된다.
export function FinzChatsClient({ initialRooms }: { initialRooms: FinzRoomSummary[] }) {
