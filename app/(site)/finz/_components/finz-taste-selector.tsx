      ...
      <div className="grid gap-5 p-5 sm:p-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="space-y-4">
          ...
          <button
            type="button"
            disabled
            title="FINZ-MVP-03에서 친구 그룹 만들기를 구현합니다"
            className="inline-flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-xl bg-slate-200 px-4 py-2 text-sm font-semibold text-slate-500"
          >
